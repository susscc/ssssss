...
function setCalendar(yy, mm) {
  ...
  out += "<caption>";
  // 今月へ戻るリンク
  out += "<a href='#' class='today' onclick='setCalendar();return false;'>今日 </a>";
  // 前月へ移動リンク
  out += "<a href='#' yy='"+yy+"' mm='"+mm+"' class='lastMonth' onclick='backmm(this);return false;'>\< </a>";
  // 翌月へ移動リンク
  out += "<a href='#' yy='"+yy+"' mm='"+mm+"' class='nextMonth' onclick='nextmm(this);return false;'>\></a>";
  out += yy+'年';
  out += "</caption>";

  out += "<tr><th colspan='7'>"+mm+"</th></tr>";
